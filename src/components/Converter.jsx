  ...
  return (
    <main>
      <section className="max-w-screen-sm mx-auto min-h-[75vh] px-4 py-8 grid grid-cols-1 gap-4 place-items-center">
        ...
        <ul className="w-full grid gap-4 text-xl pt-4">
      ...
      {!error && binary && octal && decimal && hexadecimal && (
        <section className="max-w-screen-sm mx-auto px-4 py-8 grid grid-cols-1 gap-4 place-items-center">
          <h2 className="text-4xl font-bold">
            Procedimientos: ¿Cómo llegar al resultado?
          </h2>

          <p className="text-gray-600 dark:text-gray-400">Próximamente...</p>
        </section>
      )}
    </main>
  );
